  ...
  return (
    <Box>
      <Flex px="40">
        <Box my="40">
          <Box w="full" maxW="xl">
            <Heading fontSize="30px" fontFamily="Roboto">
        ...
        <Box my="16">
          <Image src={bg_sc} />
          <Text align="right" fontSize="xx-small">
      ...
      <Center>
        ...
        <Link
          ml="1"
          href="https://docs.google.com/document/d/1JEVvmQWqASfkWdQ0ELEhA0s-oDh5mjdJNb-ThNRg2XM/edit?usp=drivesdk"
          color="red"
        >
          {' '}
