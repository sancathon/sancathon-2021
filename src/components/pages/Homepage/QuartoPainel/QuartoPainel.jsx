import { Box, HStack, Center, Heading, Link} from "@chakra-ui/react"
...
export const QuartoPainel = () =>{
  return(
    ...
    <Box
        ...
        pb='28'
        >
        <Center><Heading textShadow="0 0 8px #DA0EFC, 0 0 2px #000, -1px 0 2px #DA0EFC, 0 0 3px #fff" pt='16' color='#FFF'>APOIO</Heading></Center>
